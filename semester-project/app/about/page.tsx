      ...
      <div className="mb-4">
        ...
        <div className="flex flex-col gap-5">
          <div className="mb-4 flex flex-row gap-3 mx-auto">
            <Image src={sarahPatel} alt="Dr. Sarah Patel" width={200} className="md:h-48 h-40 rounded-lg border-[1px] border-neutral-800 md:w-48 w-40"></Image>
          ...
          <div className="mb-4 flex flex-row gap-3 mx-auto">
            ...
            <Image src={jamesNguyen} alt="Dr. James Nguyen" width={200} className="md:h-48 h-40 rounded-lg border-[1px] border-neutral-800 md:w-48 w-40"></Image>
          </div>

          <div className="mb-4 flex flex-row gap-3 mx-auto">
            <Image src={emilyDawson} alt="Nurse Emily Dawson" width={200} className="md:h-48 h-40 rounded-lg border-[1px] border-neutral-800 md:w-48 w-40"></Image>
            <div className="mt-2 flex flex-col justify-center">
          ...
          <div className="mb-4 flex flex-row gap-3 mx-auto">
            ...
            <Image src={carlosRodriguez} alt="Nurse Carlos Rodriguez" width={200} className="md:h-48 h-40 rounded-lg border-[1px] border-neutral-800 md:w-48 w-40"></Image>
          </div>
        </div>
      </div>
    </div>
